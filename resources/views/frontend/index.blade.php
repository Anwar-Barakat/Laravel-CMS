        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="entry2">
                        <a href="single.html"><img src="{{ asset('assets/frontend/images/img_1.jpg') }}" alt="Image"
                ...
                <div class="col-lg-4 mb-4">
                    <div class="entry2">
                        <a href="single.html"><img src="{{ asset('assets/frontend/images/img_2.jpg') }}" alt="Image"
                                class="img-fluid rounded"></a>
                        <div class="excerpt">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="entry2">
                        <a href="single.html"><img src="{{ asset('assets/frontend/images/img_3.jpg') }}" alt="Image"
                                class="img-fluid rounded"></a>
                        <div class="excerpt">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="entry2">
                        <a href="single.html"><img src="{{ asset('assets/frontend/images/img_4.jpg') }}" alt="Image"
                                class="img-fluid rounded"></a>
                        <div class="excerpt">
