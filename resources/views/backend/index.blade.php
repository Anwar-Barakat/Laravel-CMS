            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="morris_donught_2" class="morris_chart_height" style="height: 300px !important;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic1.jpg') }}" alt="">
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic2.jpg') }}" alt="">
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic3.jpg') }}" alt="">
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic4.jpg') }}" alt="">
                        <div class="card-body">
