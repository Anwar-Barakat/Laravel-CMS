                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('assets/backend/images/profile/education/pic1.jpg') }}"
                                        width="20" alt="" />
                                </a>
                                <div class=" dropdown-menu dropdown-menu-right">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic1.jpg') }}"
                                alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic2.jpg') }}"
                                alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic3.jpg') }}"
                                alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <img class="img-fluid" src="{{ asset('assets/backend/images/courses/pic4.jpg') }}"
                                alt="">
                            <div class="card-body">
